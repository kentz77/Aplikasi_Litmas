...
<div class="max-w-5xl mx-auto bg-white p-6 rounded-lg shadow">
    ...
    <form method="POST" action="{{ route('clients.store') }}">
        ...
        {{-- =========================
             PILIH PETUGAS (HANYA ADMIN & SUPERUSER)
        ========================== --}}
        ...
        <div>
            ...
            <input type="text" name="suku" class="w-full border rounded px-3 py-2">
        </div>

        {{-- KEBANGSAAN --}}
        <div>
            <label class="block mb-1 font-semibold">Kebangsaan</label>
            <input type="text" name="kebangsaan" class="w-full border rounded px-3 py-2">
        </div>
        ...
        <div class="mt-4">
            ...
            <textarea name="ciri_khusus" class="w-full border rounded px-3 py-2" rows="3"></textarea>
        </div>
